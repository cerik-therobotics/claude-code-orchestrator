...
```json
{"timestamp": "2026-01-26T10:30:45+00:00", "tool": "codex", "model": "gpt-5.5", "prompt": "How should I design...", "response": "I recommend...", "success": true, "exit_code": 0}
...
def test_extract_codex_prompt():
    cmd = 'codex exec --model gpt-5.5 --sandbox read-only --full-auto "test prompt"'
